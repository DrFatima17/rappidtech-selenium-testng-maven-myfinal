...
public class SeleniumUtils {
    /**
     * This class will have all the method that are reusable to implement inside our test
     * They are mostly selenium util method such as double-click, wait statements etc...
     */
    ...
    public static void fluentWaitForElementVisibility(WebDriver driver , WebElement elementToWaitFor){
        ...
        wait.withTimeout(Duration.ofSeconds(10))
                .pollingEvery(Duration.ofSeconds(2))// checking every 2 seconds,first time checks at 0 if element is visible then checks again at 2s then at 4s then at 6s etc... until 10 seconds max is reached
     ...
     * @param driver instance of the browser
     * @param -double-click on WebElement element we want to double-click
     * @throws InterruptedException
     */
