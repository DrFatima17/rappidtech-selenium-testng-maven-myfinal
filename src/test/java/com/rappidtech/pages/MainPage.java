...
public class MainPage {
    ...
    WebElement addToCartForBikeLight;
    ...
    WebElement backPackLabelInMainPage;
    @FindBy(xpath = "//a[@id='item_4_title_link']/following-sibling::div")
    WebElement backPackDescriptionInMainPage;

    @FindBy(xpath = "//div[@class='inventory_item_price'][.='$29.99']")
    WebElement backPackPriceInMainPage;
    ...
    public String getMainLogoLabel() {
        logger.info("Getting Main Logo Label");
     ...
     * @return string for the href. use .getAttribute
     */
    public String getTwitterLink() {
        logger.info("Getting href from Twitter Logo");
    ...
    public String getFacebookLink() {
        logger.info("Getting href from Facebook Logo");
    ...
    public String getLinkedInLink() {
        logger.info("Getting href from LinkedIn Logo");
    ...
    /**
     * This method will click on the Add to Cart button for the back pack item
     */
     ...
     * If its empty then the element doesn't exist on the page , if it has a value the it will be displayed
